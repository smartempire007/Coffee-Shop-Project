...
for the `npm install` i used node version 10.15.3 for installing the dependencies because the new version of node is having  installation error in some packages.